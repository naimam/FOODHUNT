...
import Tabs, {
    Tab, Button, Radio, RadioGroup, Select, CheckboxGroup,
} from '../components/MealSurveyForm';
...
class MealSurvey extends Component {
    ...
    getMealPlan(e) {
        e.preventDefault();
        const {
            mealCount, planType, healthPreferences, calories, diet,
        } = this.state;
        ...
        this.setState({ loading: true }, () => {
            fetch(`${process.env.PUBLIC_URL}/api/get-mealplan`, {
                ...
                const par = { from: 'survey', num: this.state.planType, data: data.data };
                    ...
                    this.state.loading
                        ? (
                            <div className="Survey__loading">
                                ...
                                <img src={logo} className="Survey__loading__icon" alt="survey loading icon" />
                            </div>
                        )
                        : (
